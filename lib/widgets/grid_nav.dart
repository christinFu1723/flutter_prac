...
class GridNav extends StatelessWidget{
  ...
  _doubleItem(BuildContext context,CommonModel topItem,CommonModel bottomModel,bool isCenterItem){
  ...
  _item(BuildContext context,CommonModel item,bool isCenterItem,bool isFirst){
