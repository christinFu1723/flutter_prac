...
class SearchBar extends StatefulWidget{
  ...
  const SearchBar({Key key,this.enabled=true,this.hideLeft,this.searchBarType=SearchBarType.normal,this.hint,this.defaultText,this.leftButtonClick,this.rightButtonClick,this.speakClick,this.inputBoxClick,this.onChanged});
  @override
        ...
        children: [
          _wrapTap(
            Container(
              ...
              child: (widget?.hideLeft??false)?null:Icon(Icons.arrow_back_ios,color: Colors.grey,size: 26,), //??是左边如果为空返回右边的值，否则不处理。?.左边如果为空返回 null，否则返回右边的值。,
            ),
