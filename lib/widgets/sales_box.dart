...
class SalesBox extends StatelessWidget{
            ...
            children: [
              ...
              Container(
                ...
                child:_wrapGesture(context,
                    Text('获取更多福利 >',style: TextStyle(fontSize: 12,color:Colors.white),),
                    salesBox.moreUrl,
                    '更多活动')
              )
            ],
  ...
  Widget _doubleItem(BuildContext context,BigCard1 leftCard,BigCard1 rightCard,bool big,bool last){
    return Row(
  ...
  Widget _item(BuildContext context,BigCard1 model,bool left,bool big,bool last){
    BorderSide borderSide = BorderSide(width: 0.8,color: Color(int.parse('0xfff2f2f2')));
